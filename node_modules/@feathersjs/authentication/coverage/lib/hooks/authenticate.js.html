...
<html lang="en">
<head>
    <title>Code coverage report for lib/hooks/authenticate.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">lib/hooks</a> authenticate.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const errors = require('@feathersjs/errors');
...
&nbsp;
  const strategies = Array.isArray(_strategies) ? <span class="branch-0 cbranch-no" title="branch not covered" >_strategies </span>: [ _strategies ];
&nbsp;
  return function (context) {
    const { app, params, type, data = <span class="branch-0 cbranch-no" title="branch not covered" >{} </span>} = context;
&nbsp;
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!strategy) {
<span class="cstat-no" title="statement not covered" >      return Promise.reject(new errors.GeneralError(`You must provide an authentication 'strategy'`));</span>
    }
&nbsp;
...
&nbsp;
    ...
    let request = {
      ...
      headers: context.params.headers || <span class="branch-1 cbranch-no" title="branch not covered" >{},</span>
      cookies: context.params.cookies || <span class="branch-1 cbranch-no" title="branch not covered" >{},</span>
      session: {}
    };
&nbsp;
...
&nbsp;
    return app.authenticate(strategy, strategyOptions)(request).then((result = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span> =&gt; {
