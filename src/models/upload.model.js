...
const mongooseSchema = require('../services/upload/upload.mongoose');
// !end
...
let moduleExports = function (app) {
  ...
  const upload = new mongooseClient.Schema(mongooseSchema, { timestamps: true });
  // !end

  let existingModel = mongooseClient.models['upload']; // needed for client/server tests
  let returns = existingModel || mongooseClient.model('upload', upload);
